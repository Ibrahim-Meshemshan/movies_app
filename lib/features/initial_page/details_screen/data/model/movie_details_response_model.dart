...
MovieDetailsResponseModel movieDetailsResponseModelFromJson(String str) => MovieDetailsResponseModel.fromJson(json.decode(str));

String movieDetailsResponseModelToJson(MovieDetailsResponseModel data) => json.encode(data.toJson());
@HiveType(typeId: 0)
class MovieDetailsResponseModel {
  ...
  final int? budget;
  @HiveField(5)
  final List<MoviesDetails>? genres;
  ...
  factory MovieDetailsResponseModel.fromJson(Map<String, dynamic> json) => MovieDetailsResponseModel(
    adult: json["adult"],
    backdropPath: json["backdrop_path"],
    belongsToCollection: json["belongs_to_collection"],
    budget: json["budget"],
    genres: json["genres"] == null ? [] : List<MoviesDetails>.from(json["genres"]!.map((x) => MoviesDetails.fromJson(x))),
