...
//
//     final creditsReviewResponseModel = creditsReviewResponseModelFromJson(jsonString);

import 'dart:convert';

CreditsResponseModel creditsReviewResponseModelFromJson(String str) => CreditsResponseModel.fromJson(json.decode(str));

String creditsReviewResponseModelToJson(CreditsResponseModel data) => json.encode(data.toJson());
...
class CreditsResponseModel {
  ...
  factory CreditsResponseModel.fromJson(Map<String, dynamic> json) => CreditsResponseModel(
    id: json["id"],
